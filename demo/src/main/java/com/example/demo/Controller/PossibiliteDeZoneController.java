...
public class PossibiliteDeZoneController {
    ...
    @Autowired
    public PossibiliteDeZoneController(PossibiliteDeZoneService possibiliteDeZoneService, PotentialitesDesZonesRepository potentialitesDesZonesRepository) {
    ...
    public ResponseEntity<String> importExcel(@RequestParam("file") MultipartFile file) {
        ...
        try {
            possibiliteDeZoneService.saveExcelData(potentialitesDesZonesRepository, file.getInputStream());
